...
:: Android packaging
set AND_CERT_NAME="pulupulu"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\pulupulu.p12
...
set IOS_PROVISION=cert\pulupulu.mobileprovision
...
set APP_ID=air.pulupulu

:: Output packages
set DIST_PATH=dist
set DIST_NAME=pulupulu
